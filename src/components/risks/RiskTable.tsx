        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-slate-100">
              ...
              <th className="px-3 py-2 text-left">Path strategy</th>
          ...
          <tbody>
            {rows.map((row) => (
              <tr className="border-t border-slate-200 align-top" key={row.riskId}>
                ...
                <td className="px-3 py-2 text-xs text-slate-600">{row.attackPathSourceStrategy}</td>
                ...
                <td className="px-3 py-2">
                  <p className="font-medium">{row.damageScenarioId}</p>
                  <p className="text-xs text-slate-600">{row.damageScenarioLabel}</p>
                </td>
